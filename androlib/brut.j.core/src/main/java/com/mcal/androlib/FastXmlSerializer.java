...
public class FastXmlSerializer implements XmlSerializer {
    ...
    public XmlSerializer attributesToSort(@NonNull String[] namespaces, String[] names, String[] values)
            throws IOException, IllegalArgumentException, IllegalStateException {
    ...
    public void setFeature(@NonNull String name, boolean state)
    ...
    public void writeStartTag(@NonNull XmlPullParser pp) throws XmlPullParserException, IOException {
...
//        }
    ...
    protected void writeElementContent(@NonNull String text)
            throws IOException {
